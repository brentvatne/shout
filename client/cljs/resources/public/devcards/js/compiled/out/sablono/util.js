...
sablono.util.ToString = (function (){var obj25506 = {};
return obj25506;
})();
...
return (function (){var or__3755__auto__ = (sablono.util.to_str[goog.typeOf(x__4399__auto__)]);
if(or__3755__auto__){
return or__3755__auto__;
} else {
var or__3755__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj25508 = {};
return obj25508;
})();
...
var x__4399__auto__ = (((x == null))?null:x);
return (function (){var or__3755__auto__ = (sablono.util.to_uri[goog.typeOf(x__4399__auto__)]);
if(or__3755__auto__){
return or__3755__auto__;
} else {
var or__3755__auto____$1 = (sablono.util.to_uri["_"]);
if(or__3755__auto____$1){
return or__3755__auto____$1;
} else {
...
while (G__25509__i < G__25509__a.length) {G__25509__a[G__25509__i] = arguments[G__25509__i + 0]; ++G__25509__i;}
  xs = new cljs.core.IndexedSeq(G__25509__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__25510){
var xs = cljs.core.seq(arglist__25510);
...
var vec__25512 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__25512,(0),null);
var words = cljs.core.nthnext.call(null,vec__25512,(1));
...
var G__25514 = clojure.set.rename_keys.call(null,m,kmap);
var G__25514__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__25514,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__25514);
return G__25514__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__25515_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__25515_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25515_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__25515_SHARP_)){
return p1__25515_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25515_SHARP_], null);
...
while (G__25516__i < G__25516__a.length) {G__25516__a[G__25516__i] = arguments[G__25516__i + 0]; ++G__25516__i;}
  maps = new cljs.core.IndexedSeq(G__25516__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__25517){
var maps = cljs.core.seq(arglist__25517);
...
var vec__25521 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25521,(0),null);
var names = cljs.core.nth.call(null,vec__25521,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__25521,tag_name,names){
return (function (p1__25518_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25518_SHARP_));
});})(matches,vec__25521,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__25521,tag_name,names){
return (function (p1__25519_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25519_SHARP_));
});})(matches,vec__25521,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__25522){
var vec__25525 = p__25522;
var tag = cljs.core.nth.call(null,vec__25525,(0),null);
var content = cljs.core.nthnext.call(null,vec__25525,(1));
...
var vec__25526 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__25526,(0),null);
var id = cljs.core.nth.call(null,vec__25526,(1),null);
var class$ = cljs.core.nth.call(null,vec__25526,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__3755__auto__ = x__$1.hasDomain();
